...
and both sides of records, using nonzero B and boundary values. Old snapshots
remain fixed after A changes; caller edits cannot change the CPU or another
snapshot.
...
- [Motorola instruction details, Appendix A][instructions]: RESTART and calls.
