...
- CPU state field names are case-insensitive. Uppercase is the convention for
  ...
  spellings `interruptEnabled`, `interruptDeferred`, `recognitionDeferred`, `trapPending`, `tracePending`, `nmiDeferred`, `iff1`, `iff2`, `halted`, `waiting`, `waitMode`, and `nmiArmed`; the 8008 uses
...
| 8088 | — | AX, BX, CX, DX, SP, BP, SI, DI, CS, DS, SS, ES, IP | CF, PF, AF, ZF, SF, TF, IF, DF, OF | `halted`, `waiting`, `interruptDeferred`, `recognitionDeferred`, `trapPending` |
