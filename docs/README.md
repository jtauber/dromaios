...
| --- | --- | --- | --- | --- | --- | --- |
| Intel 8080 | [Load, add, and store](cpus/8080/examples/arithmetic.md); [carry, borrow, and logic](cpus/8080/examples/alu.md); [rotates and carry](cpus/8080/examples/rotates.md) | [HL and register views](cpus/8080/examples/register-pairs.md) | [Save and restore BC](cpus/8080/examples/stack.md) | [Memory through HL](cpus/8080/examples/addressing.md) | [Registers, memory, and exchanges](cpus/8080/examples/transfers.md) | [Loop and subroutine](cpus/8080/examples/control-flow.md); [counted loop](cpus/8080/examples/counted-loop.md) |
