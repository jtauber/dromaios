...
| MOS 6502 | [Load, add, and store](cpus/6502/examples/arithmetic.md) | — | [Save and restore A](cpus/6502/examples/stack.md) | [Zero page](cpus/6502/examples/addressing.md) | — | [Counted loop](cpus/6502/examples/counted-loop.md); [nested subroutines](cpus/6502/examples/subroutines.md) |
...
| Zilog Z80 | [Arithmetic and 8080 comparison](cpus/z80/examples/arithmetic.md) | — | — | — | [Buffer fill and readback](cpus/z80/examples/transfers.md) | [Counted loop](cpus/z80/examples/counted-loop.md) |
