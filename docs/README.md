...
| Zilog Z80 | [Arithmetic and 8080 comparison](cpus/z80/examples/arithmetic.md); [two-byte checksum](cpus/z80/examples/checksum.md); [decimal total and alternate banks](cpus/z80/examples/decimal-total.md) | — | [Bit counting and nested calls](cpus/z80/examples/bit-count.md) | — | [Buffer fill and readback](cpus/z80/examples/transfers.md) | [Counted loop](cpus/z80/examples/counted-loop.md) |
