...
import { instructions6502, sources6502, instructions6800, instructions8008, instructions8080, instructions8088, transfers8088, alu8088, instructions6809, instructionsZ80 } from "../src/components/cpus/semantics/definitions.ts";
...
export function generateCpuSemantics(directory: string): void {
  ...
  modules.push(["8088-transfers", generateInstructions("8088", transfers8088)], ["8088-alu", generateInstructions("8088", alu8088)]);
