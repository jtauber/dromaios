...
import { instructions6502, sources6502, instructions6800, instructions8080, instructions6809 } from "../src/components/cpus/semantics/definitions.ts";
...
export function generateCpuSemantics(directory: string): void {
  const modules = ([
    ["6502", instructions6502], ["6800", instructions6800], ["8080", instructions8080], ["6809", instructions6809],
