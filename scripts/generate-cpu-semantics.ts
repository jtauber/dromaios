...
import { instructions6502, sources6502, instructions6800, instructions8008, instructions8080, instructions6809, instructionsZ80 } from "../src/components/cpus/semantics/definitions.ts";
...
export function generateCpuSemantics(directory: string): void {
  const modules = ([
    ["6502", instructions6502], ["6800", instructions6800], ["8008", instructions8008], ["8080", instructions8080], ["6809", instructions6809], ["z80", instructionsZ80],
