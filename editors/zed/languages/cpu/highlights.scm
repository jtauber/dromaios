[
  ...
  "terminal" "trace" "exception" "fetched" "inputs" "exceptions"
  "events" "capture" "prepare" "stack" "check" "short" "frame" "bytes" "entry" "return"
  "fault" "frame" "fault" "vectors" "bus" "function" "code" "values" "fault" "begin" "halt"
  "initial" "fetch" "processing" "levels" "gate" "reasons" "autovector" "spurious" "maximum" "interrupt" "return" "plus" "restart"
