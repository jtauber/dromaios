...
module.exports = grammar({
  ...
  rules: {
    ...
    choose_capture: $ => seq(field('name', $._local_name), '=', 'choose', $._expression, ':', $._value_type,
      '{', 'then', $.body, 'else', $.body, '}'),
    match_capture: $ => seq(field('name', $._local_name), '=', 'match', $._expression, ':', $._value_type,
    ...
    iteration_value: $ => seq(field('name', $._local_name), ':', $._value_type, '=', $._expression),
    ...
    capture: $ => seq(field('name', $._local_name), choice(
      seq(':', $._value_type, '=', $._expression), seq('=', choice($._read, $._expression)))),
    _read: $ => choice(
