...
test("8080/Z80 numeric definitions cover 84 transfer, twelve word-arithmetic, two exchange, ten jump, and 32 stack/subroutine slots, excluding HALT", () => {
  const expected = [...forms.map(({ opcode }) => opcode),
    0xc1, 0xd1, 0xe1, 0xc5, 0xd5, 0xe5,
    0xc0, 0xc8, 0xd0, 0xd8, 0xe0, 0xe8, 0xf0, 0xf8, 0xc9,
    0xc4, 0xcc, 0xd4, 0xdc, 0xe4, 0xec, 0xf4, 0xfc, 0xcd,
    0xc7, 0xcf, 0xd7, 0xdf, 0xe7, 0xef, 0xf7, 0xff, 0x01, 0x11, 0x21, 0x31, 0x22, 0x2a, 0xf9,
