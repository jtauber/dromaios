...
test("native CPU generation bootstraps without generated files and removes obsolete output", t => {
  ...
  const run = () => {
    ...
    assert.deepEqual(readdirSync(output).sort(), ["6502-interrupts.ts", "6502.ts", "6800.ts", "68000-arithmetic.ts", "68000-bits.ts", "68000-logic.ts", "68000-moves.ts", "68000-quick.ts", "68000.ts", "6809.ts", "8008.ts", "8080.ts", "8088-addressing.ts", "8088-alu.ts", "8088-arithmetic.ts", "8088-control.ts", "8088-stack.ts", "8088-strings.ts", "8088-transfers.ts", "8088-unary.ts", "8088.ts", "z80.ts"]);
    for (const cpu of ["6502-interrupts", "6502", "6800", "68000-arithmetic", "68000-bits", "68000-logic", "68000-moves", "68000-quick", "68000", "6809", "8008", "8080", "8088-addressing", "8088-alu", "8088-arithmetic", "8088-control", "8088-stack", "8088-strings", "8088-transfers", "8088-unary", "8088", "z80"]) {
