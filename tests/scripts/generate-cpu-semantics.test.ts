...
test("native CPU generation bootstraps without generated files and removes obsolete output", t => {
  ...
  const chapterNames = ["6502.ts", "6800.ts", "68000-word-transfers.ts", "6809.ts", "8008.ts", "8080.ts", "catalogue.ts", "interfaces.ts"];
  const chapterFiles = [...chapterNames, "state/6502.ts", "state/6800.ts", "state/6809.ts", "state/8008.ts", "state/8080.ts"];
  ...
  const run = () => {
    ...
    assert.deepEqual(readdirSync(join(chapters, "state")).sort(), ["6502.ts", "6800.ts", "6809.ts", "8008.ts", "8080.ts"]);
