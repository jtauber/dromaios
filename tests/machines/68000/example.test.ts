...
import type { Cpu68000Snapshot, Cpu68000StepRecord } from "../../../src/components/cpus/generated/68000-cpu.js";
...
function initialState(): Cpu68000Snapshot {
  return { d0: 0x11223344, d1: 0x55667788, d2: 0x99aabbcc, d3: 0xddeeff00,
    ...
    pc: 0xab001000, ir: 0, faulted: false, entry: { kind: "none", vector: 0 }, halted: false, tracePending: false, interruptMask: 2, a7: 0x34ffe000, physicalPc: 0x1000,
...
test("68000 example pauses and resumes, resets from vectors, and restarts with independent initial state", () => {
  ...
  const after = { ...before, entry: { kind: "reset", vector: 0 } as const, ssp: 0x12fff000, a7: 0x12fff000, pc: 0xab001000, physicalPc: 0x1000,
