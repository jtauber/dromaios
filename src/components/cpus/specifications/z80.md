...
instruction forms, and their prefix layouts. Reset, execution boundaries,
and external interrupt delivery still use TypeScript. The
...
layouts, displacements, and complete instruction behavior. Reset, ordinary
execution boundaries, external IRQ/NMI delivery, and the public interface
remain in the handwritten core. Instruction coverage therefore reaches 100%
while model migration remains at three of six milestones.
