...
import { instructions8088 } from "./definitions/8088.ts";
...
export { instructions6502, sources6502, instructions6800, instructions8008, instructions8080, instructions8088, instructions6809, instructionsZ80 };

/** One inventory for executable generation and the explanatory listing. */
export const instructionDefinitions = Object.freeze([
  ...Object.values(instructions6502), ...Object.values(instructions6800), ...Object.values(instructions8008), ...Object.values(instructions8080), ...Object.values(instructions8088), ...Object.values(instructions6809), ...Object.values(instructionsZ80),
]);
