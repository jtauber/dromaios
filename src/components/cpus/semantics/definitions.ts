...
import { instructions8088, operandInstructions8088, strings8088 } from "./definitions/8088.ts";
import { actions as actions8088, views as views8088 } from "./generated/8088.ts";
...
export { instructions68000, quick68000, moves68000, wordMoves68000, logic68000, arithmetic68000, bits68000, wordArithmetic68000, decimal68000, control68000, transfers68000, system68000, instructions8088, operandInstructions8088, strings8088 };
...
export const instructionModules: readonly InstructionModule[] = Object.freeze<readonly InstructionModule[]>([
  ...
  { name: "8088-state", cpu: "8088", definitions: actions8088, options: {
    state: { name: "StoredState", module: "../semantics/generated/state/8088.ts" }, origin: "specifications/8088.md",
    sources: { cpu: { name: "8088", state: cpu8088StateDescription }, groups: { views: views8088 } },
  } },
  { name: "8088", cpu: "8088", definitions: instructions8088, options: { bindOpcodes: true } },
  { name: "8088-operands", cpu: "8088", definitions: operandInstructions8088, options: { origin: "specifications/8088.md" } },
  { name: "8088-strings", cpu: "8088", definitions: strings8088, options: { origin: "specifications/8088.md" } },
]);
