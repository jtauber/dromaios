...
export { instructions6502, sources6502, instructions6800, instructions8080, instructions6809 };

/** One inventory for executable generation and the explanatory listing. */
export const instructionDefinitions = Object.freeze([
  ...Object.values(instructions6502), ...Object.values(instructions6800), ...Object.values(instructions8080), ...Object.values(instructions6809),
]);
